    ...
    "Rust Benchmark": [
      ...
      },
      {
        commit: {
          ...
          message:
            "Add CentralContour, using caching of the last relevant dominant point",
      ...
      },
      {
        commit: {
          ...
          message:
            "Increase threshold for failed benchmarks -- sadly it's not very accurate",
      ...
      },
      {
        commit: {
          ...
          message:
            "Add config setting to disable sorting of BucketQueue elements",
      ...
      },
      {
        commit: {
          ...
          message:
            "Replace HintContours::value_in_slice by binary search again",
      ...
      },
      {
        commit: {
          ...
          message:
            "Move double expand check into A* to save a hashmap insert/lookup",
      ...
      },
      {
        commit: {
          ...
          message:
            "Fix test: Add is_start_of_seed, prune_with_hint to EqualHeuristic",
      ...
      },
      {
        commit: {
          ...
          distinct: true,
          id: "9b001ab6cd7df252407b4fd6d1098be1ce68e9ea",
          message: "Fix name of benchmark action",
          timestamp: "2022-01-22T23:12:28+01:00",
          tree_id: "1e40cdca681bf45b2c9a2bd44b2b986fed8a069a",
          url: "https://github.com/RagnarGrootKoerkamp/astar-pairwise-aligner/commit/9b001ab6cd7df252407b4fd6d1098be1ce68e9ea",
        },
        date: 1642889801586,
        tool: "cargo",
        benches: [
